...
$h1 = '"color":"#000000","font-family":"googlefonts:PT Sans","font-size":"30px","line-height":"180%"';
$h2 = '"color":"#000000","font-family":"googlefonts:PT Sans","font-size":"25px","line-height":"180%"';
$h3 = '"color":"#000000","font-family":"googlefonts:PT Sans","font-size":"20px","line-height":"180%"';
...
$getElementsStyles = function ($prefix) use ($text, $h1, $h2, $h3, $input, $link, $image, $button, $date, $userImage, $separator) {
    ...
    return [
        ...
        $prefix . 'BlogPostsPostTitleCSS' => '{' . $link . ',"font-family":"googlefonts:PT Sans","font-size":"22px"}',
...
$result = [
    'headerCSS' => '{"max-width":"860px","margin-left":"auto","margin-right":"auto","padding-bottom":"60px","padding-top":"80px"}',
    ...
    'headerTitleCSS' => '{"font-family":"googlefonts:PT Sans","font-size":"35px","color":"#111111","padding-bottom":"20px"}',
    'headerTitleContainerCSS' => '{"padding-left":"20px","padding-right":"20px", "text-align":"center"}',
    'headerDescriptionVisibility' => '1',
    'headerDescriptionCSS' => '{"font-family":"googlefonts:PT Sans","font-size":"15px","color":"#333333","padding-bottom":"20px"}',
    ...
    'navigationCSS' => '{"max-width":"820px","margin-left":"auto","margin-right":"auto"}',
    ...
    'navigationContainerCSS' => '{"text-align":"center","border-top":"1px solid #ddd","border-bottom":"1px solid #ddd"}',

    'homePageSpecialContentBlockVisibility' => '1',
    'homePageSpecialContentBlockCSS' => '{"max-width":"860px","margin-left":"auto","margin-right":"auto","padding-top":"20px","padding-right":"20px","padding-bottom":"20px","padding-left":"20px"}',
    'homePageSpecialContentBlockContainerCSS' => '{"background-color":"#000000","border-top":"1px solid rgba(0,0,0,0.8)","border-bottom":"1px solid rgba(0,0,0,0.8)","background-image":"url(addon:bearcms\/universal-theme-addon:assets\/s19\/1.jpg)","background-position":"center center","background-repeat":"no-repeat","background-size":"cover"}',

    'contentCSS' => '{"padding-top":"20px","padding-right":"15px","padding-bottom":"20px","padding-left":"15px","min-height":"300px"}',
    'contentContainerCSS' => '{"max-width":"860px","margin-left":"auto","margin-right":"auto"}',

    'footerVisibility' => '1',
    'footerCSS' => '{"max-width":"860px","margin-left":"auto","margin-right":"auto","padding-top":"20px","padding-right":"15px","padding-bottom":"20px","padding-left":"15px"}',
    'footerContainerCSS' => '{"border-top":"1px solid #ddd"}',
